...
const Form = () => {
    ...
    const isErrorPname = pname === ''
    const isErrorAadhar = mobile === ''
    const isErrorimage = image === ''

    const nameValid = useRef(null);
    const validMobile = useRef(null)
    const ValidEmail= useRef(null)
    const ValidAddress = useRef(null)
    const pnameValid = useRef(null)
    const validAadhar = useRef(null)
    ...
    const submitData = async (e) => {
        ...
        if (!name) {
            ...
            ValidAddress.current.focus()
        }else if (!pname) {
            alert("Enter Your Parent's Name !")
            pnameValid.current.focus()
        }else if (!aadhar) {
            alert("Enter Your Aadhar Number!")
            validAadhar.current.focus()
        }else if (!image) {
                        ...
                        <div className="col-12 col-md-6">
                            <div className="form pl-3 pr-3">
                                ...
                                <form>
                                    ...
                                    <FormControl isInvalid={isError}>
                                        <FormLabel fontSize={'14px'} mt={4}>Email Id <sup style={{ color: 'red' }}><span>*</span></sup></FormLabel>
                                        <Input
                                            type='text'
                                            name="email"
                                    ...
                                    <FormControl isInvalid={isError}>
                                        <FormLabel fontSize={'14px'} mt={4}>Parent's Name <sup style={{ color: 'red' }}><span>*</span></sup></FormLabel>
                                        <Input
                                            type='text'
                                            name="pname"
                                    ...
                                    <FormControl isInvalid={isErrorAadhar}>
                                        <FormLabel fontSize={'14px'} mt={4}>Aadhar Number <sup style={{ color: 'red' }}><span>*</span></sup></FormLabel>
                                        <Input
                                            type='text'
                                            name="aadhar"
                                            placeholder="Enter Your Aadhar No."
                                            ref={validAadhar}
                                            maxLength={14} // Setting max length to 14 for "xxxx xxxx xxxx" format
                                            value={aadhar}
